      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div class="md:col-span-1">
          <div class="flex flex-col items-start">
            <svg class="w-10 h-10 text-primary mb-4" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/>
            </svg>
            <span class="font-serif text-2xl font-bold tracking-wider">SEAFRONT VILLAS</span>
          </div>
          <p class="mt-4 text-gray-400 text-sm leading-relaxed">
            Your exclusive partner for luxury villas and properties along the French Riviera and Mediterranean coast.
          </p>
        </div>
        ...
        <!-- Destinations -->
        <div>
          <h4 class="text-sm font-semibold uppercase tracking-wider mb-6">Destinations</h4>
          <ul class="space-y-3">
            <li><a href="#" class="text-gray-400 hover:text-primary transition text-sm">French Riviera</a></li>
            <li><a href="#" class="text-gray-400 hover:text-primary transition text-sm">Cannes</a></li>
            <li><a href="#" class="text-gray-400 hover:text-primary transition text-sm">Saint-Tropez</a></li>
            <li><a href="#" class="text-gray-400 hover:text-primary transition text-sm">Nice</a></li>
            <li><a href="#" class="text-gray-400 hover:text-primary transition text-sm">Monaco</a></li>
          </ul>
        </div>

        <!-- Contact -->
        <div>
          <h4 class="text-sm font-semibold uppercase tracking-wider mb-6">Contact Us</h4>
          <ul class="space-y-3">
